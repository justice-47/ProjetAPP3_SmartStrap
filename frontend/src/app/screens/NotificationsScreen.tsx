...
export default function NotificationsScreen() {
      ...
      {data.map((item) => (
        <TouchableOpacity
          ...
          style={[
            ...
            !item.is_read && styles.highlightedItem,
          ]}
        ...
        >
          <View
            style={[
              ...
              !item.is_read && styles.highlightedIconContainer,
            ]}
          >
            <Ionicons
          ...
          <View style={styles.textContainer}>
            <View style={styles.notifHeaderRow}>
              <Text
                style={[
                  styles.notifTitle,
                  !item.is_read && styles.highlightedText,
                ]}
              >
                {item.title}
              </Text>
  ...
  return (
    <SafeAreaView
      style={[styles.container, { backgroundColor: "#00386A" }]}
      edges={["top"]}
    >
