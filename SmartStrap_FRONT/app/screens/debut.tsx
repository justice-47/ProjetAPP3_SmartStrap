...
export default function Debut() {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <AppButton titre="connexion" couleurbouton="#00386A" couleurtitre="#ffffffff" largeur={250} onPress={() => {alert('connexion en cours.......')}} />
      <AppButton titre="inscription" couleurbouton="#2260FF" couleurtitre="#ffffffff" largeur={250} onPress={() => {alert('inscription en cours.......')}} />
    </SafeAreaView>
  );
}
